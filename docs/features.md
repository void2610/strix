...
- バックグラウンド再生（`AVAudioSession` + `UIBackgroundModes: audio`）
- PiP（`AVPictureInPictureController`、iOS 14+）

### 2. 動画検索・ホームフィード表示

- YouTube Data API v3 で検索・メタデータ取得
- ホームフィード表示（YouTubeKit / Innertube）
